#!/usr/bin/env bash
# Serve repos/core/blockly/ on localhost:8767 and open electrical-preview.html.
# Stop with Ctrl-C.
#
...
URL="http://localhost:${PORT}/electrical-preview.html"

if [ ! -f "${DIR}/electrical-preview.html" ]; then
  echo "✗ ${DIR}/electrical-preview.html not found" >&2
  exit 1
fi
